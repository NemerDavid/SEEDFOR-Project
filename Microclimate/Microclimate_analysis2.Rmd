...
```
Posthoc comparisons revealed several distinct groups based on their mean temperatures:

- Sites with open canopy exhibited lower mean temperatures compared to semi-closed and closed sites.
- Site 5 had the highest mean temperature among all sites.
...
```
Posthoc comparisons revealed distinctive groups:

Sites with open canopy generally had lower maximum temperatures compared to semi-closed and closed sites.
Site 5 had the highest maximum temperature among all sites.
::: {style="margin-bottom: 70px;"}
:::
...
plot(p3)
```
Posthoc comparisons revealed distinct groups:

Sites with open canopy generally had lower minimum temperatures compared to semi-closed and closed sites.
Site 6 had the highest minimum temperature among all sites.
::: {style="margin-bottom: 70px;"}
:::
...
Sites with closed canopy generally had lower mean temperatures compared to semi-closed and open sites.
Site 6 had the highest mean temperature among all sites.
::: {style="margin-bottom: 70px;"}
:::
...
plot(p5)
```
Sites with closed canopy generally had lower maximum temperatures compared to semi-closed and open sites.
Site 5 had the highest maximum temperature among all sites.
::: {style="margin-bottom: 70px;"}
:::
...
Sites with closed canopy generally had lower minimum temperatures compared to semi-closed and open sites.
Site 6 had the highest minimum temperature among all sites.
...
Sites with closed canopy generally had lower minimum temperatures compared to semi-closed and open sites.
Site 5 had the highest minimum temperature among all sites.
::: {style="margin-bottom: 70px;"}
:::
...
Sites with closed canopy generally had lower mean temperatures compared to semi-closed and open sites.
Among closed canopy sites, Site 1 had the lowest mean temperature.
Among semi-closed canopy sites, Site 1 had a lower mean temperature compared to Site 2.
Among open canopy sites, Site 1 had a lower mean temperature compared to Site 2.
::: {style="margin-bottom: 70px;"}
:::
...
Sites with closed canopy generally had lower maximum temperatures compared to semi-closed and open sites.
Among closed canopy sites, Site 1 had the lowest maximum temperature.
Among semi-closed canopy sites, Site 2 had a lower maximum temperature compared to Site 1.
Among open canopy sites, Site 2 had a lower maximum temperature compared to Site 1.
::: {style="margin-bottom: 70px;"}
:::
...
Sites with open canopy generally had lower minimum temperatures compared to semi-closed and closed sites.
Among open canopy sites, Site 1 had the lowest minimum temperature.
Among semi-closed canopy sites, Site 1 had a lower minimum temperature compared to Site 2.
Among closed canopy sites, Site 1 had a lower minimum temperature compared to Site 2.
